...
**Tip**: Use `/im-lost` to see your current workflow position if you lose context.
...
- `/work` - Workflow-aware task execution with checkpoints (`<issue-number>`, `URL`, `"description"`)
