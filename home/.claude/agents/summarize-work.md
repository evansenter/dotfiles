...
Use AskUserQuestion:
- Question: "Post this summary to PR #N?"
- Options: "Post summary (Recommended)" / "Skip"

Only ask if conditions from step 2 are met.
...
---
*Generated by summarize-work agent*
EOF
)"
```

Use "## Work Summary" as the marker so future runs can detect existing summaries.
