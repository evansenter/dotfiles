...
- Suggestions that were deferred but never followed up
- Patterns in feedback that indicate systemic issues

Categorize findings as:
- **Actionable**: Should become new issues
- **Stale**: No longer relevant given current code
