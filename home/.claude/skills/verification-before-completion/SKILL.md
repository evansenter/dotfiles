...
**Tests:**
```
RUN test command → SEE "34/34 pass" → THEN say "All tests pass"
NOT: "Should pass now" / "Looks correct"
```

**Build:**
```
RUN build → SEE exit 0 → THEN say "Build succeeds"
NOT: "Linter passed so build is fine"
```
...
ALWAYS before:
- ANY completion or success claims
